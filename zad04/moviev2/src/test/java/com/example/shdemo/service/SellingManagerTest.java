...
public class SellingManagerTest {
	...
	public void addClientCheck() {
		...
		List<Movie> retrievedClients = sellingManager.getAllClients();
		...
		Movie retrievedClient = sellingManager.findClientByPin(PIN_1);
	...
	public void sellCarCheck() {
		...
		Movie retrievedPerson = sellingManager.findClientByPin(PIN_2);
